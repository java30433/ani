...
import static dev.dirs.Util.AIX;
import static dev.dirs.Util.BSD;
import static dev.dirs.Util.IBMI;
import static dev.dirs.Util.LIN;
import static dev.dirs.Util.MAC;
import static dev.dirs.Util.SOLARIS;
import static dev.dirs.Util.WIN;
import static dev.dirs.Util.defaultIfNullOrEmptyExtended;
import static dev.dirs.Util.getWinDirs;
import static dev.dirs.Util.isNullOrEmpty;
import static dev.dirs.Util.linuxRuntimeDir;
import static dev.dirs.Util.macOSApplicationPath;
import static dev.dirs.Util.operatingSystem;
import static dev.dirs.Util.operatingSystemName;
import static dev.dirs.Util.requireNonNull;
import static dev.dirs.Util.trimLowercaseReplaceWhitespace;
import static dev.dirs.Util.windowsApplicationPath;
